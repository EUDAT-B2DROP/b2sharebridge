...
//        '</div>';
        ...
        function publishAction(e){
            ...
            var selected_community = external_jQuery_default()("#ddCommunitySelector").val();
			var open_access = external_jQuery_default()('input[name="open_access"]:checked').length > 0;
			var title = external_jQuery_default()("#b2s_title").val();
        ...
        getCommunitySelectorHTML: function() {
            ...
            external_jQuery_default().each(
                this.getCommunities().filter(function(community) {
                    return community.serverId.toString() === external_jQuery_default()('#ddServerSelector').val().toString();
                }),
                function(i, c) {
