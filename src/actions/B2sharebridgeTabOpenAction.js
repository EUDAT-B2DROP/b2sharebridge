...
export const action = new FileAction({
	...
	async exec(node, view, dir) {
		...
		let result = await filepicker([node])//await openB2SharePickerForAction(dir, [node])
		return result
	},
	...
	async execBatch(nodes, view, dir) {
		...
		let result = await filepicker(nodes)//await openB2SharePickerForAction(dir, nodes)
		return result
	},
