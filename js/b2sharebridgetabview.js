...
//        '</div>';
    ...
    function publishAction(e) {
        jquery_default()(publish_button).prop('disabled', true);
        ...
        let selected_community = jquery_default()("#ddCommunitySelector").val();
        let open_access = jquery_default()('input[name="open_access"]:checked').length > 0;
        let title = jquery_default()("#b2s_title").val();
        jquery_default().post(
            OC.generateUrl('/apps/b2sharebridge/publish'),
            {
                ...
                title: title,
                server_id: jquery_default()('#ddServerSelector').val()
            },
            function (result) {
    ...
    var B2shareBridgeTabView = OCA.Files.DetailTabView.extend(
        /** @lends OCA.B2shareBridge.B2shareBridgeTabView.prototype */{
            ...
            getTokens: function () {
                ...
                if (!this.tokens) {
                    ...
                    jquery_default().ajax({
                        ...
                        let b2sharebridge_errormsg = jquery_default()("#b2sharebridge_errormsg")
            ...
            getCommunitySelectorHTML: function () {
                ...
                let ddserver = jquery_default()('#ddServerSelector');
            ...
            getServerSelectorHTML: function () {
                ...
                jquery_default().ajax({
                    ...
                    jquery_default().each(data, function (key, value) {
            ...
            checkToken: function () {
                let b2sharebridge_errormsg = jquery_default()("#b2sharebridge_errormsg")
                if (!this.tokens[jquery_default()('#ddServerSelector').val()]) {
            ...
            onChangeServer: function () {
                jquery_default()("#communitySelector").html(this.getCommunitySelectorHTML());
                this.checkToken();
            },
