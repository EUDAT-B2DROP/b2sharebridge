 ...
 */
class Version030000Date20230203105446 extends SimpleMigrationStep {
	...
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
        ...
        $table->addColumn('max_uploads', \OCP\DB\Types::INTEGER, [
            'notnull' => true,
            'default' => 5,
        ]);

        $table->addColumn('max_upload_filesize', \OCP\DB\Types::INTEGER, [
            'notnull' => true,
            'default' => 512,
        ]);

        $table->addColumn('check_ssl', \OCP\DB\Types::BOOLEAN, [
            'notnull' => true,
            'default' => false,
        ]);
