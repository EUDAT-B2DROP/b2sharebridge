...
<div class="section" id="eudat_b2share">
    ...
    <p name="b2share_url_field" id="b2shareUrlField">
        ...
        <span class="regexstatus success" name="regexstatus_success" id="regexstatusSuccess" style="visibility: hidden"></span>
        <span class="regexstatus error" name="regexstatus_error" id="regexstatusError" style="visibility: hidden"></span>
        <br />
