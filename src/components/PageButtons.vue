<template>
    <div v-if="numPages" class="pagebuttons">
        <NcButton class="pagebuttons__left" aria-label="First Page" :disabled="isFirstPage" @click="updatePageFirst">
            <template #icon>
                <PageFirst :size="20" />
            </template>
        </NcButton>
        <NcButton class="pagebuttons__middle" aria-label="Previous Page" :disabled="isFirstPage"
            @click="updatePageDecrement">
            <template #icon>
                <ChevronLeft :size="20" />
            </template>
        </NcButton>
        <NcButton class="pagebuttons__middle" aria-label="Next Page" :disabled="isLastPage"
            @click="updatePageIncrement">
            <template #icon>
                <ChevronRight :size="20" />
            </template>
        </NcButton>
        <NcButton class="pagebuttons__right" aria-label="Last Page" :disabled="isLastPage" @click="updatePageLast">
            <template #icon>
                <PageLast :size="20" />
            </template>
        </NcButton>
